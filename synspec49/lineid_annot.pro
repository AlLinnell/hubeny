pro lannot2,wave,flux,wline,eqw,text1,text2,text3,  $
        charsize=charsize,extend=extend,charthick=charthick,_extra=e
;+
;				lineid_plot2b
;
...
; plot data
;
        plot,wave,flux,title=' ',xstyle=1,_extra=e
;
; get data ranges
;
	xmin = !x.crange(0)
...
print_text:
	...
	start_text1 = stop_arrow + yrange/95*maxcsize
	start_text2 = start_text1 +  $
			max(strlen(strtrim(txt1,1)))*yrange/95*maxcsize
